 ...
 */
internal class ObservabilityObjectSearchResult : SearchResults<BaseObjectData> {

    /**
     * single item result constructor
     */
    constructor(objectItem: BaseObjectData) : super(CONFIG_LIST_TAG, objectItem)

    /**
     * multiple items result constructor
     */
    constructor(objectList: List<BaseObjectData>) : this(
        0,
    ...
    constructor(
        ...
        objectList: List<BaseObjectData>
